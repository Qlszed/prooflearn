...
export default function Landing() {
  return <main className="landing shell">
    ...
    <section className="hero">
      <div className="hero-copy"><p className="eyebrow">A three-minute academic defence</p><h1>Verify understanding,<br /><em>not authorship.</em></h1><p className="lede">Turn any student submission into a personalized 3-minute oral defence.</p><Link className="button primary" href="/setup">Create Verification <span>→</span></Link><p className="fine-print">We don&apos;t detect AI. We verify learning.</p></div>
